...
def add_guard_arguments(parser: argparse.ArgumentParser, require_input: bool = True) -> None:
    ...
    parser.add_argument("--whisper_path", default="openai/whisper-small")
    ...
    parser.add_argument("--weight_stft", type=float, default=0.0)
    parser.add_argument("--weight_snr", type=float, default=0.0)
    parser.add_argument("--target_snr_db", type=float, default=18.0)
    parser.add_argument("--selection_snr_db", type=float, default=None)
...
def create_guard(args: argparse.Namespace):
    ...
    from core.guard import SemanticE2EVGuard

    device = torch.device(args.device)
    return SemanticE2EVGuard(
